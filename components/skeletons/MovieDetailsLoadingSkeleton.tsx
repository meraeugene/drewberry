    ...
    <main className="relative min-h-screen overflow-hidden bg-[#07020b] text-white">
      ...
      <div className="relative z-10">
        <section className="px-4 pb-8 pt-24 sm:px-6 sm:pb-10 sm:pt-32 lg:px-9 lg:pb-12">
          <div className="mb-5 h-10 w-10 animate-pulse rounded-full bg-white/10" />
          <div className="h-5 w-32 animate-pulse rounded bg-[#ff75bd]/40" />
          <div className="mt-5 h-14 w-[min(760px,84vw)] animate-pulse rounded bg-white/10 sm:h-20" />
          <div className="mt-6 flex flex-wrap gap-3 sm:mt-7 sm:gap-5">
            {Array.from({ length: 6 }).map((_, index) => (
              <div
                key={index}
                className="h-9 w-16 animate-pulse rounded-[7px] bg-white/10 sm:h-10 sm:w-20"
              />
            ))}
          </div>
          <div className="mt-6 grid max-w-[min(850px,86vw)] gap-3 sm:mt-7">
            <div className="h-4 animate-pulse rounded bg-white/10" />
            <div className="h-4 animate-pulse rounded bg-white/10" />
            <div className="h-4 w-4/5 animate-pulse rounded bg-white/10" />
          </div>
          <div className="mt-7 flex gap-3 sm:mt-9 sm:gap-5">
        ...
        <section className="grid gap-9 border-t border-white/10 px-4 py-8 sm:px-6 lg:grid-cols-[minmax(0,520px)_minmax(0,1fr)] lg:gap-24 lg:px-9">
          <div>
            <div className="h-8 w-28 animate-pulse rounded bg-[#ff75bd]/40" />
          ...
          <aside className="min-w-0">
            <div className="h-8 w-56 animate-pulse rounded bg-[#ff75bd]/40" />
